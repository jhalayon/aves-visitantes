...
const birds = [
  ...
  {
    key: 'Fulica atra',
    image: '/art-pilot/focha-comun-fulica-atra.png',
    className: 'bird-focha-comun',
    width: '27vw',
    rotation: '4deg',
    delay: '-2s',
  },
  {
    key: 'Haliaeetus pelagicus',
    image: '/art-pilot/pigargo-gigante-haliaeetus-pelagicus.png',
    className: 'bird-pigargo-gigante',
    width: '29vw',
    rotation: '-4deg',
    delay: '-8s',
  },
  {
    key: 'Cygnus columbianus',
    image: '/art-pilot/cisne-chico-cygnus-columbianus.png',
    className: 'bird-cisne-chico',
    width: '29vw',
    rotation: '3deg',
    delay: '-5s',
  },
  {
    key: 'Columbina inca',
    image: '/art-pilot/tortolita-mexicana-columbina-inca.png',
    className: 'bird-tortolita-mexicana',
    width: '27vw',
    rotation: '-5deg',
    delay: '-10s',
  },
  {
    key: 'Aegolius acadicus',
    image: '/art-pilot/mochuelo-cabezon-aegolius-acadicus.png',
    className: 'bird-mochuelo-cabezon',
    width: '25vw',
    rotation: '4deg',
    delay: '-1s',
  },
  {
    key: 'Saxicola caprata',
    image: '/art-pilot/tarabilla-pia-saxicola-caprata.png',
    className: 'bird-tarabilla-pia',
    width: '26vw',
    rotation: '-3deg',
    delay: '-6s',
  },
  {
    key: 'Stercorarius longicaudus',
    image: '/art-pilot/pagalo-rabero-stercorarius-longicaudus.png',
    className: 'bird-pagalo-rabero',
    width: '29vw',
    rotation: '5deg',
    delay: '-4s',
  },
  {
    key: 'Branta leucopsis',
    image: '/art-pilot/barnacla-cariblanca-branta-leucopsis.png',
    className: 'bird-barnacla-cariblanca',
    width: '29vw',
    rotation: '-4deg',
    delay: '-9s',
  },
